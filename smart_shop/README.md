## Smart SHhop Project
# Introduction
A CLI (Command Line Interface) application built with Python . It offers an interactive menu for users to manage their products with permanent tracking
...
* **`operation.py`**: Contains the core logic for the application loop. It handles the CRUD operations (Create, Read, Update).
