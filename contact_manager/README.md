...
## Introduction
A CLI (Command Line Interface) application built with Python. It allows users to efficiently track and manage their contacts, featuring a search functionality and automatic timestamps for tracking when each contact was added.
